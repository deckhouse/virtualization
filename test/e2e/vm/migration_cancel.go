...
var _ = Describe("VirtualMachineCancelMigration", Label(precheck.NoPrecheck), func() {
	...
	It("Cancel migrate", func() {
		...
		By("Create memory pressure inside virtual machines", func() {
		...
		By("Create migration VMOPs", func() {
		...
		By("Collect migration VMOP names, delete them and verify they are gone", func() {
