...
const (
	ImageURLAlpineUEFIPerf = "https://e2e-test-images.e2e.virtlab.flant.com/alpine-3-21-uefi-perf.qcow2"
	ImageURLUbuntu         = "https://e2e-test-images.e2e.virtlab.flant.com/ubuntu-24.04-minimal-cloudimg-amd64.qcow2"
	ImageURLAlpineBIOS     = "https://e2e-test-images.e2e.virtlab.flant.com/alpine-3-21-bios-base.qcow2"
