...
// snapshotPrecheck implements PrecheckWithEnv interface for snapshot-controller module.
...
func (s *snapshotPrecheck) EnvName() string {
	return snapshotModuleCheckEnvName
}
