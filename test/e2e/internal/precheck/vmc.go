...
const (
	...
	vmClassGVR    = "virtualmachineclasses.virtualization.deckhouse.io"
	vmClassVersion = "v1alpha3"
)

// vmcPrecheck implements common Precheck interface for VMC/VMClass.
...
func (c *vmcPrecheck) EnvName() string {
	return vmcModuleCheckEnvName
}
