...
// storageClassPrecheck implements common Precheck interface for default StorageClass.
...
func (c *storageClassPrecheck) EnvName() string {
	return storageClassPrecheckEnvName
}
