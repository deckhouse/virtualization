...
// virtualizationPrecheck implements PrecheckWithEnv interface for virtualization module.
...
func (v *virtualizationPrecheck) EnvName() string {
	return virtualizationModuleCheckEnvName
}
