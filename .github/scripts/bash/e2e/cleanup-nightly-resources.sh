...
# Nested clusters are heavy, so every one of them is torn down after ~1 day,
# regardless of storage type. Clusters created on Friday live through the weekend.
KEEP_HOURS="${KEEP_HOURS:-23}"
