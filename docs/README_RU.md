...
Шаг 1: Для включения модуля требуется кластер Deckhouse Kubernetes Platform развернутый по [инструкции](https://deckhouse.ru/gs/#%D0%B4%D1%80%D1%83%D0%B3%D0%B8%D0%B5-%D0%B2%D0%B0%D1%80%D0%B8%D0%B0%D0%BD%D1%82%D1%8B).
...
Шаг 2: Для хранения данных виртуальных машин необходимо включить один из следующих модулей согласно инструкции по их установке:
...
Шаг 3: Для включения модуля создайте манифест mc.yaml со следующим содержимым:
