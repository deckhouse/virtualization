...
### Загрузка образа из веб интерфейса

- Перейдите во вкладку "Система", далее в раздел "Виртуализация" -> "Кластерные образы"
- Нажмите "Создать образ", далее в выпадающем списке выберите "Загрузить с компьютера".
- В поле "Имя образа" введите имя образа.
- В блоке "Загрузить файл" нажмите "Выберите файл на вашем компьютере" или перетащите в эту область требуемый файл образа.
- Нажмите "Создать".
- Дождитесь пока образ перейдет в состояние "Готов".
