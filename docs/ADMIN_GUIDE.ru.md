...
- Перейдите во вкладку "Система", далее в раздел "Deckhouse" -> "Модули"
...
- Перейдите во вкладку "Система", далее в раздел "Виртуализация" -> "Кластерные образы"
...
- Перейдите во вкладку "Система", далее в раздел "Виртуализация" -> "Классы ВМ"
- Нажмите кнопку "Создать"
...
- Класс c универсальным vCPU для заданного набора узлов. Для этого используйте `type: Discovery`:
  ...
  - Во всплывающем окне можете задать "Ключ", "Оператор" и "Значение" ключа, что соотвествует настройкам `spec.cpu.discovery.nodeSelector`
...
- Во всплывающем окне можете задать "Ключ", "Оператор" и "Значение" ключа, что соотвествует настройкам `spec.nodeSelector`
- Для подтверждения параметров ключа нажмите кнопку "Enter"
- Для создания класса ВМ нажмите кнопку "Создать"
...
- Перейдите во вкладку "Проекты" и выберите нужный проект.
...
- Перейдите во вкладку "Система", далее в раздел "Узлы" -> "Узлы всех групп"
