...
После включения модуля система начинает самостоятельно следить за оптимальной работой виртуальных машин в кластере. Основные возможности, которые он предоставляет:
