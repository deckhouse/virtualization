...
To perform an unattended installation of Windows, encode the answer file
(usually named unattend.xml or autounattend.xml) into base64 and insert it into a secret.
