...
- Consider existing `taints` on nodes. If necessary, you can add appropriate `tolerations` to a VM. An example of using `tolerations` to restrict `key1=value1:NoSchedule` is provided below.
