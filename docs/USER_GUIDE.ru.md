...
- `ReadWriteOnce (RWO)` - доступ к диску предоставляется только одному экземпляру виртуальной машины. Живая миграция виртуальных машин с такими дисками возможна только для платных редакций DVP.
...
- VirtualMachineMACAddress — MAC адрес дополнительных сетевых интерфейсов, при подключении ВМ к дополнительным сетям;
