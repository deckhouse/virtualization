...
1. Создайте диск виртуальной машины из образа, созданного на предыдущем шаге (Внимание: перед созданием убедитесь, что в системе присутствует StorageClass по умолчанию):
   ...
   Как выполнить операцию в веб-интерфейсе (данный шаг можно пропустить и выполнить при создании ВМ):
...
1. Создайте виртуальную машину:
   ...
   - В появившееся поле вставьте Ваши данные:
     ...
     ```
   - Нажмите кнопку "Создать"
   - Статус ВМ отображается слева вверху, под именем ВМ.
...
- Перейдите во вкладку "Система", далее в раздел "Хранилище" -> "Классы хранилищ"
...
- Перейдите во вкладку "Проекты" и выберите нужный проект.
- Перейдите в раздел "Виртуализация" -> "Диски ВМ"
- Выберите нужный диск и нажмите на символ "Карандаш" в колонке "Размер"
...
Статические блочные устройства в веб-интерфейсе:
...
Динамические блочные устройства в веб-интерфейсе:
