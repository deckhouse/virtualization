...
{{< alert level="info" >}}
На гостевой системе Linux с несколькими интерфейсами в разных подсетях IPv4 возможен ARP flux: на соседних узлах в кэше ARP могут оказаться неверные соответствия IPv4–MAC, при отключении одного интерфейса может пропасть доступ к адресам в другой подсети. Поведение определяется гостевой ОС.

Чтобы исправить, выполните на гостевой ОС:
