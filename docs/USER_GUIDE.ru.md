...
При создании виртуальной машины вы можете настроить, сколько процессорных ресурсов она будет использовать с помощью параметров `cores` и `coreFraction`. 
...
Рассмотрим пример:
Если указать `cores: 2`, ВМ будет выделено два виртуальных ядра соответствующих двум физическим ядрам гипервизора. 
...
Например, указав в политике значение `coreFraction: 20%` вы гарантируете любой ВМ не менее 20% вычислительных ресурсов процессора, что фактически определит максимально возможную переподписку 5:1.
