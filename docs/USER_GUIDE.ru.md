...
Если параметр `.spec.persistentVolumeClaim.storageClassName` не указан, то будет использован `StorageClass` по умолчанию на уровне кластера, либо для образов, если он указан в [настройках модуля](./ADMIN_GUIDE.ru.md#настройки-классов-хранения-для-образов).
...
Если параметр `.spec.persistentVolumeClaim.storageClassName` не указан, то будет использован `StorageClass` по умолчанию на уровне кластера, либо для образов, если он указан в [настройках модуля](./ADMIN_GUIDE.ru.md#настройки-классов-хранения-для-дисков).
...
- [класс виртуальной машины](ADMIN_GUIDE.ru.md#классы-виртуальных-машин)
