...
{{< alert level="info">}}
Этот подход напоминает переподписку процессорных ресурсов, где ВМ может использовать больше мощности, чем зарезервировано, если ресурсы доступны. Но coreFraction при этом гарантирует ВМ запрошенный объем ресурсов. Это делает работу ВМ стабильной даже при высокой нагрузке на кластер.
{{< /alert >}}
