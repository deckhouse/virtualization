...
- Не используйте статический заданный IP-адрес в VirtualMachineIPAddress. Если использовался статический адрес - сконвертируйте его в автоматический.
...
После успешного создания снимка в его статусе будет отражен перечень ресурсов, которые были сохранены снимков.
