...
Данное ограничение может вызвать проблемы при использовании:

- **BitLocker** — может потребоваться повторная настройка или использование альтернативных методов шифрования;
- **Windows Hello** — функции биометрической аутентификации могут работать нестабильно;
- **Другие функции безопасности**, требующие постоянного хранения ключей в TPM.
```yaml
spec:
  cpu:
    cores: 1
