...
=======
Кластерные сетевые политики не действуют на дополнительные сетевые интерфейсы. Проверьте и настройте необходимые правила безопасности внутри виртуальной машины.
{{< /alert >}}
