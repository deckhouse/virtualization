...
Для диагностики проблем с виртуальной машиной можно использовать команду `collect-debug-info`, которая собирает полную информацию о состоянии ВМ и всех связанных ресурсов в сжатый архив.
...
- Блочные устройства
- Связанные PVC и PV
- Под'ы (Pods), связанные с ВМ, включая их логи (последние 10000 строк)
