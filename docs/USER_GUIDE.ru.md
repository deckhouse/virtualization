...
- Учитывайте существующие ограничения (`taints`) на узлах. При необходимости можно добавить соответствующие `tolerations` на ВМ. Пример использования `tolerations` для ограничения `key1=value1:NoSchedule`
