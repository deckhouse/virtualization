...
Virtualization covers the following scenarios:
...
- Creating Deckhouse Platform (DP) clusters.

  ![Deckhouse Platform clusters on virtual machines](./images/cases.dkp.png)
...
| `virtualization-audit-*`      | Auxiliary   | Records security events for the module resources. Available in commercial DP editions.                 |
| `virtualization-dra-*`        | Auxiliary   | Detects USB devices on nodes and passes them through to machines. Available in commercial DP editions. |
