...
- [vi,cvi] Добавили отслеживание наличия образа в DVCR: Если образ пропадёт из DVCR, в статусе соответствующих ресурсов `VirtualImage` и `ClusterVirtualImage` будет соответствующая фаза `Lost` и ошибка.
