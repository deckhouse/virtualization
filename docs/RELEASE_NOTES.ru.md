...
- [module] Удалили использование устаревшей версии `admissionregistration.k8s.io/v1beta1` в хуке, что могло блокировать обновление виртуализации в кластере с Kubernetes версией >=1.34. 
