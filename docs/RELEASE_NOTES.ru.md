...
- [vm] Требуется действие для обновления прошивки на виртуальных машинах с подключенным USB-устройством (соответствующий призыв к миграции появится в статусе виртуальной машины):
       - либо отключить флешку и мигрировать виртуальную машину;
       - либо перезапустить виртуальную машину.
       До выполнения действий виртуальная машина будет работать, но ее не получится мигрировать.
       После выполненного действия виртуальная машина будет на актуальной версии прошивки и вновь будет готова к миграции.
