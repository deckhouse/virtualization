...
**Обратите внимание:** при обновлении на эту версию будут обновлены компоненты запуска виртуальных машин. Для работающих ВМ выполнится автоматическая миграция.
