...
- [vmclass] Добавили возможность изменения или удаления `VirtualMachineClass` generic. Теперь модуль виртуализации не будет его восстанавливать в исходное состояние.
