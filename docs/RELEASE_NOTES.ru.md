...
- [module] Добавлена возможность планировать сборку мусора (garbage collection) для DVCR:
...
- [vmclass] Добавлена возможность изменять или удалять generic-ресурс `VirtualMachineClass`. Теперь модуль виртуализации не будет восстанавливать его в исходное состояние.
