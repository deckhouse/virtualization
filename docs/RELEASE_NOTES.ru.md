...
- [vm] Исправили миграцию виртуальных машин с дополнительными интерфейсами. Теперь порты для миграции выдаются DHCP сервером модуля cilium.
- [vm] Исправили удаление служебных подов (`d8v-hp-*`) при отсоединении дисков виртуальных машин.
