...
- [module] Для роли `d8:use:role:user` исправили права на операции запуска, перезапуска, остановки, миграции и восстановления виртуальных машин (взаимодействие с ресурсами `VirtualMachineOperation`). 
