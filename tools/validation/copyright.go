...
var (
	fileToCheckRe = regexp.MustCompile(`\.go$|/[^/.]+$|\.sh$|\.lua$|\.py$|^\.github/(scripts|workflows|workflow_templates)/.+\.(js|yml|yaml|sh)$`)
	fileToSkipRe  = regexp.MustCompile(`geohash.lua$|\.github/CODEOWNERS|Dockerfile$|id_ed$|Makefile$|Taskfile|/docs/|bashrc$|inputrc$|modules_menu_skip$|LICENSE$`)
)
