...
- name: LOG_LEVEL
  value: {{ .Values.virtualization.internal.moduleConfig.logLevel }}
{{- if eq .Values.virtualization.internal.moduleConfig.logLevel "debug" }}
- name: LOG_DEBUG_VERBOSITY
  value: "10"
{{- end }}
- name: LOG_FORMAT
  value: {{ .Values.virtualization.internal.moduleConfig.logFormat }}
