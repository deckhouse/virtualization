...
{{- define "kubevirt.nowebhook_kubeproxy_patch" -}}
  '{{ include "kubevirt.nowebhook_kubeproxy_patch_tmpl" . | fromYaml | toJson }}'
{{- end }}

{{- define "kubevirt.nowebhook_kubeproxy_patch_tmpl" -}}
  {{- $ctx := index . 0 -}}
