...
└── [drwxr-xr-x     4]  usr
    ...
    │   └── [drwxr-xr-x     6]  ngtcp2
    │       ├── [-rw-r--r--  196K]  ngtcp2.h
    │       ├── [-rw-r--r--   36K]  ngtcp2_crypto.h
    │       ├── [-rw-r--r--  3.6K]  ngtcp2_crypto_gnutls.h
    │       └── [-rw-r--r--  1.6K]  version.h
    └── [drwxr-xr-x    11]  lib64
        ├── [-rwxr-xr-x   919]  libngtcp2.la
        ├── [lrwxrwxrwx    19]  libngtcp2.so -> libngtcp2.so.16.2.9
...
libngtcp2_crypto_gnutls.so.8.2.0
        ...
        └── [drwxr-xr-x     4]  pkgconfig
            ...
            └── [-rw-r--r--  1.3K]  libngtcp2_crypto_gnutls.pc
