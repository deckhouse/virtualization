...
$SRC_BUILD/ui-spice-core.so to /usr/lib64/qemu
$SRC_BUILD/ui-spice-app.so to /usr/lib64/qemu
...
$SRC_BUILD/hw-display-qxl.so to /usr/lib64/qemu
...
$SRC_BUILD/audio-spice.so to /usr/lib64/qemu
$SRC_BUILD/chardev-spice.so to /usr/lib64/qemu
