...
const (
	...
	dvcrMaintenancePath = "virtualization.internal.dvcr.maintenanceEnabled"

	startMaintenanceAnno = "dvcr.virtualization.deckhouse.io/maintenance-enabled"
)
...
func isMaintenanceEnabled(secrets []partialSecret) string {
	...
	if _, ok := secrets[0].Metadata.Annotations[startMaintenanceAnno]; ok {
		return "true"
	}
