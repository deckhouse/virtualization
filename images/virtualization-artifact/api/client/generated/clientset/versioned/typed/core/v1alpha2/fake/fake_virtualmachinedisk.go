...
var virtualmachinedisksResource = v1alpha2.SchemeGroupVersion.WithResource("virtualmachinedisks")

var virtualmachinedisksKind = v1alpha2.SchemeGroupVersion.WithKind("VirtualMachineDisk")
...
func (c *FakeVirtualMachineDisks) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.VirtualMachineDisk, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(virtualmachinedisksResource, c.ns, name), &v1alpha2.VirtualMachineDisk{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.VirtualMachineDisk), err
}
...
func (c *FakeVirtualMachineDisks) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VirtualMachineDiskList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(virtualmachinedisksResource, virtualmachinedisksKind, c.ns, opts), &v1alpha2.VirtualMachineDiskList{})
	...
	list := &v1alpha2.VirtualMachineDiskList{ListMeta: obj.(*v1alpha2.VirtualMachineDiskList).ListMeta}
	for _, item := range obj.(*v1alpha2.VirtualMachineDiskList).Items {
...
func (c *FakeVirtualMachineDisks) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(virtualmachinedisksResource, c.ns, opts))
...
func (c *FakeVirtualMachineDisks) Create(ctx context.Context, virtualMachineDisk *v1alpha2.VirtualMachineDisk, opts v1.CreateOptions) (result *v1alpha2.VirtualMachineDisk, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(virtualmachinedisksResource, c.ns, virtualMachineDisk), &v1alpha2.VirtualMachineDisk{})
...
func (c *FakeVirtualMachineDisks) Update(ctx context.Context, virtualMachineDisk *v1alpha2.VirtualMachineDisk, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachineDisk, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(virtualmachinedisksResource, c.ns, virtualMachineDisk), &v1alpha2.VirtualMachineDisk{})
...
func (c *FakeVirtualMachineDisks) UpdateStatus(ctx context.Context, virtualMachineDisk *v1alpha2.VirtualMachineDisk, opts v1.UpdateOptions) (*v1alpha2.VirtualMachineDisk, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(virtualmachinedisksResource, "status", c.ns, virtualMachineDisk), &v1alpha2.VirtualMachineDisk{})
...
func (c *FakeVirtualMachineDisks) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(virtualmachinedisksResource, c.ns, name, opts), &v1alpha2.VirtualMachineDisk{})
...
func (c *FakeVirtualMachineDisks) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(virtualmachinedisksResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha2.VirtualMachineDiskList{})
	return err
}
...
func (c *FakeVirtualMachineDisks) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.VirtualMachineDisk, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(virtualmachinedisksResource, c.ns, name, pt, data, subresources...), &v1alpha2.VirtualMachineDisk{})
