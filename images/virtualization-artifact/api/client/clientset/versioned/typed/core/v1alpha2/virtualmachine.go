...
func (c *virtualMachines) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.VirtualMachine, err error) {
	result = &v1alpha2.VirtualMachine{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *virtualMachines) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VirtualMachineList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.VirtualMachineList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("virtualmachines").
...
func (c *virtualMachines) Create(ctx context.Context, virtualMachine *v1alpha2.VirtualMachine, opts v1.CreateOptions) (result *v1alpha2.VirtualMachine, err error) {
	result = &v1alpha2.VirtualMachine{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualmachines").
...
func (c *virtualMachines) Update(ctx context.Context, virtualMachine *v1alpha2.VirtualMachine, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachine, err error) {
	result = &v1alpha2.VirtualMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachines").
...
func (c *virtualMachines) UpdateStatus(ctx context.Context, virtualMachine *v1alpha2.VirtualMachine, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachine, err error) {
	result = &v1alpha2.VirtualMachine{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachines").
...
func (c *virtualMachines) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.VirtualMachine, err error) {
	result = &v1alpha2.VirtualMachine{}
