...
// VirtualMachineIPAddressClaimsGetter has a method to return a VirtualMachineIPAddressClaimInterface.
...
// virtualMachineIPAddressClaims implements VirtualMachineIPAddressClaimInterface
type virtualMachineIPAddressClaims struct {
	client rest.Interface
	ns     string
}

// newVirtualMachineIPAddressClaims returns a VirtualMachineIPAddressClaims
func newVirtualMachineIPAddressClaims(c *VirtualizationV1alpha2Client, namespace string) *virtualMachineIPAddressClaims {
	return &virtualMachineIPAddressClaims{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *virtualMachineIPAddressClaims) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.VirtualMachineIPAddressClaim, err error) {
	result = &v1alpha2.VirtualMachineIPAddressClaim{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *virtualMachineIPAddressClaims) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VirtualMachineIPAddressClaimList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.VirtualMachineIPAddressClaimList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("virtualmachineipaddressclaims").
...
func (c *virtualMachineIPAddressClaims) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *virtualMachineIPAddressClaims) Create(ctx context.Context, virtualMachineIPAddressClaim *v1alpha2.VirtualMachineIPAddressClaim, opts v1.CreateOptions) (result *v1alpha2.VirtualMachineIPAddressClaim, err error) {
	result = &v1alpha2.VirtualMachineIPAddressClaim{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualmachineipaddressclaims").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(virtualMachineIPAddressClaim).
		Do(ctx).
		Into(result)
	return
}
...
func (c *virtualMachineIPAddressClaims) Update(ctx context.Context, virtualMachineIPAddressClaim *v1alpha2.VirtualMachineIPAddressClaim, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachineIPAddressClaim, err error) {
	result = &v1alpha2.VirtualMachineIPAddressClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachineipaddressclaims").
		Name(virtualMachineIPAddressClaim.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(virtualMachineIPAddressClaim).
		Do(ctx).
		Into(result)
...
func (c *virtualMachineIPAddressClaims) UpdateStatus(ctx context.Context, virtualMachineIPAddressClaim *v1alpha2.VirtualMachineIPAddressClaim, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachineIPAddressClaim, err error) {
	result = &v1alpha2.VirtualMachineIPAddressClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachineipaddressclaims").
...
func (c *virtualMachineIPAddressClaims) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *virtualMachineIPAddressClaims) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *virtualMachineIPAddressClaims) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.VirtualMachineIPAddressClaim, err error) {
	result = &v1alpha2.VirtualMachineIPAddressClaim{}
