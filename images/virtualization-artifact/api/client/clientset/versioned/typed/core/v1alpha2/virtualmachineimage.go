...
func newVirtualMachineImages(c *VirtualizationV1alpha2Client, namespace string) *virtualMachineImages {
...
func (c *virtualMachineImages) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.VirtualMachineImage, err error) {
	result = &v1alpha2.VirtualMachineImage{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *virtualMachineImages) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VirtualMachineImageList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.VirtualMachineImageList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("virtualmachineimages").
...
func (c *virtualMachineImages) Create(ctx context.Context, virtualMachineImage *v1alpha2.VirtualMachineImage, opts v1.CreateOptions) (result *v1alpha2.VirtualMachineImage, err error) {
	result = &v1alpha2.VirtualMachineImage{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("virtualmachineimages").
...
func (c *virtualMachineImages) Update(ctx context.Context, virtualMachineImage *v1alpha2.VirtualMachineImage, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachineImage, err error) {
	result = &v1alpha2.VirtualMachineImage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachineimages").
...
func (c *virtualMachineImages) UpdateStatus(ctx context.Context, virtualMachineImage *v1alpha2.VirtualMachineImage, opts v1.UpdateOptions) (result *v1alpha2.VirtualMachineImage, err error) {
	result = &v1alpha2.VirtualMachineImage{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("virtualmachineimages").
...
func (c *virtualMachineImages) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.VirtualMachineImage, err error) {
	result = &v1alpha2.VirtualMachineImage{}
