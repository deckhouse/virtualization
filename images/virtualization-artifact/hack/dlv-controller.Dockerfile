...
# `task dlv:build:controller` (see Taskfile dlv tasks); the Dockerfile only packages them.
WORKDIR /app
COPY ./images/virtualization-artifact/hack/out/dlv /app/dlv
COPY ./images/virtualization-artifact/hack/out/virtualization-controller /app/virtualization-controller
USER 65532:65532
