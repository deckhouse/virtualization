...
func NewCommand(clientConfig clientcmd.ClientConfig) *cobra.Command {
	cmd := &cobra.Command{
		...
		Short:   "Forward local ports to a virtualmachine",
		Long:    usage(),
		Example: examples(),
...
func examples() string {
  ...
  ssh -o 'ProxyCommand={{ProgramName}} port-forward --stdio=true testvm.mynamespace 22' user@testvmi.mynamespace

  # Use as SCP ProxyCommand:
  scp -o 'ProxyCommand={{ProgramName}} port-forward --stdio=true testvm.mynamespace 22' local.file user@testvmi.mynamespace`
}
