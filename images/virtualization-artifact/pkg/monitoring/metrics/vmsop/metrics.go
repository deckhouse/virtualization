...
const (
	MetricVMSOPStatusPhase = "virtualmachinesnapshotoperation_status_phase"
)
...
var vmsopMetrics = map[string]metrics.MetricInfo{
	MetricVMSOPStatusPhase: metrics.NewMetricInfo(MetricVMSOPStatusPhase,
		"The virtualmachinesnapshotoperation current phase.",
