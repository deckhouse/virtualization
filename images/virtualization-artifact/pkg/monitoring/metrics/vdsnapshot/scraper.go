...
func (s *scraper) Report(m *dataMetric) {
	...
	s.updateMetricVDSnapshotLabels(m)
	s.updateMetricVDSnapshotAnnotations(m)
}
...
func (s *scraper) updateMetricVDSnapshotLabels(m *dataMetric) {
	s.updateDynamic(MetricVDSnapshotLabels, 1, m, nil, m.Labels)
}

func (s *scraper) updateMetricVDSnapshotAnnotations(m *dataMetric) {
	s.updateDynamic(MetricVDSnapshotAnnotations, 1, m, nil, m.Annotations)
}
