...
func (v *SingleDefaultClassValidator) ValidateCreate(ctx context.Context, vmClass *virtv2.VirtualMachineClass) (admission.Warnings, error) {
...
func (v *SingleDefaultClassValidator) ValidateUpdate(ctx context.Context, _, newVMClass *virtv2.VirtualMachineClass) (admission.Warnings, error) {
...
func (v *SingleDefaultClassValidator) checkDefaultIsSingle(ctx context.Context, vmClass *virtv2.VirtualMachineClass) error {
