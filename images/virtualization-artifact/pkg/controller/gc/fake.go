...
func NewFakeObject(name string, namespace string) *FakeObject {
...
func (f *fakeGCManager) ListForDelete(ctx context.Context) ([]client.Object, error) {
	...
	result := DefaultFilter(objs, f.ShouldBeDeleted, f.ttl, f.getIndex, f.max)
