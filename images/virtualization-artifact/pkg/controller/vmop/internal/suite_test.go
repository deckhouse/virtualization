...
func setupEnvironment(vmop *virtv2.VirtualMachineOperation, objs ...client.Object) (client.WithWatch, *service.Resource[*virtv2.VirtualMachineOperation, virtv2.VirtualMachineOperationStatus], state.VMOperationState) {
	GinkgoHelper()
	...
	srv := service.NewResource(key, fakeClient,
