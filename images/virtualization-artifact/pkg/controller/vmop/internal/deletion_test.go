...
import (
	...
	"github.com/deckhouse/virtualization/api/client/builder"
...
var _ = Describe("DeletionHandler", func() {
	var (
		...
		srv        *service.Resource[*virtv2.VirtualMachineOperation, virtv2.VirtualMachineOperationStatus]
	...
	reconcile := func() {
		...
		h := NewDeletionHandler(fakeClient, vmopSrv)
	...
	DescribeTable("Should protected", func(vmop *virtv2.VirtualMachineOperation, protect bool) {
