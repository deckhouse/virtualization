...
// }
//
// func getCurrentVirtualMachineBlockDeviceAttachments(ctx context.Context, client client.Client, vmName, vmNamespace, vmRestoreUID string) ([]*virtv2.VirtualMachineBlockDeviceAttachment, error) {
// 	vmbdas := &virtv2.VirtualMachineBlockDeviceAttachmentList{}
// 	err := client.List(ctx, vmbdas, &client.ListOptions{Namespace: vmNamespace})
// 	if err != nil {
...
// }
//
// func deleteCurrentVirtualMachineBlockDeviceAttachments(ctx context.Context, client client.Client, vmbdas []*virtv2.VirtualMachineBlockDeviceAttachment) error {
// 	for _, vmbda := range vmbdas {
// 		err := object.DeleteObject(ctx, client, client.Object(vmbda))
// 		if err != nil {
...
// }
//
// func createBatch(ctx context.Context, objs ...client.Object) error {
...
// }
//
// func getVMRestoreVMOP(ctx context.Context, vmNamespace, vmRestoreUID string, vmopType virtv2.VMOPType) (*virtv2.VirtualMachineOperation, error) {
// 	vmops := &virtv2.VirtualMachineOperationList{}
// 	err := client.List(ctx, vmops, &client.ListOptions{Namespace: vmNamespace})
// 	if err != nil {
// 		return nil, err
// 	}
//
...
// }
//
// func stopVirtualMachine(ctx context.Context, vmName, vmNamespace, vmRestoreUID string) error {
// 	vmopStop, err := getVMRestoreVMOP(ctx, vmNamespace, vmRestoreUID, virtv2.VMOPTypeStop)
// 	if err != nil {
...
// }
//
// func startVirtualMachine(ctx context.Context, vmRestore *virtv2.VirtualMachineRestore) error {
// 	vms := &virtv2.VirtualMachineList{}
// 	err := client.List(ctx, vms, &client.ListOptions{Namespace: vmRestore.Namespace})
// 	if err != nil {
...
// }
//
// func checkKVVMDiskStatus(ctx context.Context, client client.Client, vmName, vmNamespace string) error {
...
// }
//
// func updateVMRunPolicy(ctx context.Context, client client.Client, vmObj *virtv2.VirtualMachine, runPolicy virtv2.RunPolicy) error {
