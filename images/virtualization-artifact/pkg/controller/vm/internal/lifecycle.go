...
func syncStartedAt(vm *v1alpha2.VirtualMachine) {
	...
	if vm.Status.Stats.StartedAt != nil {
		return
	}

	vm.Status.Stats.StartedAt = running.LastTransitionTime.DeepCopy()
}
