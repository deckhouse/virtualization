...
// (status.recommendedResources.cpu.coreFraction, or the autoscaling seed until the autoscaler
// sets it). This keeps KVVM rendering, change detection and quota math on a concrete
