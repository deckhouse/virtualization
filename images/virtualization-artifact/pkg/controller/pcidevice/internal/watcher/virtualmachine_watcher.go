...
func shouldProcessVirtualMachineUpdate(oldObj, newObj *v1alpha2.VirtualMachine) bool {
	...
	return !equality.Semantic.DeepEqual(oldObj.Spec.PCIDevices, newObj.Spec.PCIDevices) ||
		!equality.Semantic.DeepEqual(oldObj.Status.PCIDevices, newObj.Status.PCIDevices) ||
