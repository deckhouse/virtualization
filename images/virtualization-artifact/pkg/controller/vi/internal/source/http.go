...
func (ds HTTPDataSource) CleanUp(ctx context.Context, vi *v1alpha2.VirtualImage) (requeue bool, reason string, err error) {
	supgen := supplements.NewGenerator(annotations.VIShortName, vi.Name, vi.Namespace, vi.UID)
...
func (ds HTTPDataSource) getSource(sup supplements.Generator, dvcrSourceImageName string) *service.PVCImportSource {
