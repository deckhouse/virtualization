...
var _ = Describe("Sources helpers", func() {
	...
	DescribeTable(
		...
		Entry("marks pvc lost when pvc is missing", nil, v1alpha2.ImagePVCLost, metav1.ConditionFalse, vicondition.PVCLost.String(), "The underlying PersistentVolumeClaim was not found."),
