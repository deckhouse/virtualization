...
// generateOUI creates a 6-character OUI (Organizationally Unique Identifier) from a given UUID.
// This function ensures the generated OUI fits within one of the required MAC address ranges
// for VM network interfaces in a cluster. The accepted ranges are:
// x2-xx-xx-xx-xx-xx
// x6-xx-xx-xx-xx-xx
// xA-xx-xx-xx-xx-xx
// xE-xx-xx-xx-xx-xx
//
// If the initial part of the UUID doesn't match these allowed ranges, the second character
// of the resulting OUI is changed to '2' to guarantee compliance.
