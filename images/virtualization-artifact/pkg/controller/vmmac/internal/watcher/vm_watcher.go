	...
	return ctr.Watch(
		...
		predicate.Funcs{
			...
			UpdateFunc: func(e event.UpdateEvent) bool {
				...
				return oldVM.Spec.VirtualMachineMACAddress != newVM.Spec.VirtualMachineMACAddress ||
					oldVM.Status.VirtualMachineMACAddress != newVM.Status.VirtualMachineMACAddress
			},
		},
	)
}
...
func (w VirtualMachineWatcher) enqueueRequests(ctx context.Context, obj client.Object) []reconcile.Request {
	...
	if vm.Spec.VirtualMachineMACAddress != "" {
		vmmacNames[vm.Spec.VirtualMachineMACAddress] = struct{}{}
	}

	if vm.Status.VirtualMachineMACAddress != "" {
		vmmacNames[vm.Status.VirtualMachineMACAddress] = struct{}{}
	}

	vmmacs := &virtv2.VirtualMachineIPAddressList{}
