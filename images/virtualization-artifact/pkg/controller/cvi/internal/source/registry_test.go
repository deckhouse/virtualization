...
// var _ = Describe("RegistryDataSource Run", func() {
...
//		cvi.Spec.DataSource.Type = virtv2.DataSourceTypeContainerImage
//		cvi.Spec.DataSource.ContainerImage = &virtv2.DataSourceContainerRegistry{
//			Image: "registry.hub.example.com/example/example:latest",
//		}
//	})
//
