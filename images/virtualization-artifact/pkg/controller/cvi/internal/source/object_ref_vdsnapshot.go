...
func (ds ObjectRefVirtualDiskSnapshot) getEnvSettings(cvi *virtv2.ClusterVirtualImage, sup *supplements.Generator, volumeMode *corev1.PersistentVolumeMode) *importer.Settings {
