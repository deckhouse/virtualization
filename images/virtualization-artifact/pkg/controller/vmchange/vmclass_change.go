...
func compareVMClassNodeSelector(current, desired *virtv2.VirtualMachineClassSpec) []FieldChange {
	isEmpty := func(nodeSelector virtv2.NodeSelector) bool {
...
func compareVMClassTolerations(current, desired *virtv2.VirtualMachineClassSpec) []FieldChange {
