...
func (mock *SnapshotterMock) CanFreeze(ctx context.Context, vm *v1alpha2.VirtualMachine) (bool, error) {
...
func (mock *SnapshotterMock) IsFrozen(ctx context.Context, vm *v1alpha2.VirtualMachine) (bool, error) {
