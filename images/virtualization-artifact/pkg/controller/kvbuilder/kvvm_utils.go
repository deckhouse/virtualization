...
import (
	...
	"github.com/deckhouse/virtualization-controller/pkg/common/deckhouse"
...
func ApplyVirtualMachineSpec(
	...
	// Add inhibit node shutdown label.
	kvvm.SetKVVMILabel(deckhouse.InhibitNodeShutdownLabel, "")
