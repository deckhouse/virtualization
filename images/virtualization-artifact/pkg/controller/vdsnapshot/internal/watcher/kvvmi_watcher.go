...
func (w VirtualMachineWatcher) filterUpdateEvents(e event.UpdateEvent) bool {
	...
	oldFSReady, _ := conditions.GetConditionByType(vmcondition.TypeFilesystemReady.String(), oldKVVMI.Status.Conditions)
	newFSReady, _ := conditions.GetConditionByType(vmcondition.TypeFilesystemReady.String(), newKVVMI.Status.Conditions)
