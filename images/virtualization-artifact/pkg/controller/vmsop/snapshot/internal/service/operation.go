...
func NewOperationService(client client.Client, recorder eventrecord.EventRecorderLogger, vmop *v1alpha2.VirtualMachineSnapshotOperation) (Operation, error) {
	switch vmop.Spec.Type {
	case v1alpha2.VMSOPTypeClone:
