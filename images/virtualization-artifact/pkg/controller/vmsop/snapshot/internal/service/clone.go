...
func NewCloneOperation(client client.Client, eventRecorder eventrecord.EventRecorderLogger, vmop *v1alpha2.VirtualMachineSnapshotOperation) *CloneOperation {
...
type CloneOperation struct {
	vmop     *v1alpha2.VirtualMachineSnapshotOperation
