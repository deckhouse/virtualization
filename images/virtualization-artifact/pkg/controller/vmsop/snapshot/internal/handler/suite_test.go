...
func setupEnvironment(vmop *v1alpha2.VirtualMachineSnapshotOperation, objs ...client.Object) (client.WithWatch, *reconciler.Resource[*v1alpha2.VirtualMachineSnapshotOperation, v1alpha2.VirtualMachineSnapshotOperationStatus]) {
	GinkgoHelper()
