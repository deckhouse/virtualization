...
type SvcOpCreator func(vmop *v1alpha2.VirtualMachineSnapshotOperation) (service.Operation, error)

func NewSvcOpCreator(client client.Client, recorder eventrecord.EventRecorderLogger) SvcOpCreator {
	return func(vmop *v1alpha2.VirtualMachineSnapshotOperation) (service.Operation, error) {
