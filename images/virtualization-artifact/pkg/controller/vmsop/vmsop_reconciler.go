...
import (
	...
	"github.com/deckhouse/virtualization-controller/pkg/controller/vmsop/internal/watcher"
	"github.com/deckhouse/virtualization/api/core/v1alpha2"
)

type Handler interface {
	Handle(ctx context.Context, vmSnapshot *v1alpha2.VirtualMachineSnapshotOperation) (reconcile.Result, error)
}
