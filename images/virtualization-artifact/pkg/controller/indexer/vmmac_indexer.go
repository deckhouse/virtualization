...
func IndexVMMACByVM() (obj client.Object, field string, extractValue client.IndexerFunc) {
	return &v1alpha2.VirtualMachineMACAddress{}, IndexFieldVMMACByVM, func(object client.Object) []string {
		vmmac, ok := object.(*v1alpha2.VirtualMachineMACAddress)
		if !ok || vmmac == nil {
			return nil
		}
...
func IndexVMMACByAddress() (obj client.Object, field string, extractValue client.IndexerFunc) {
	return &v1alpha2.VirtualMachineMACAddress{}, IndexFieldVMMACByAddress, func(object client.Object) []string {
		vmmac, ok := object.(*v1alpha2.VirtualMachineMACAddress)
		if !ok || vmmac == nil {
			return nil
		}
