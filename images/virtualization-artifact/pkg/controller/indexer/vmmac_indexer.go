...
func IndexVMMACByAddress(ctx context.Context, mgr manager.Manager) error {
	return mgr.GetFieldIndexer().IndexField(ctx, &virtv2.VirtualMachineMACAddress{}, IndexFieldVMMACByAddress, func(object client.Object) []string {
		vmmac, ok := object.(*virtv2.VirtualMachineMACAddress)
		if !ok || vmmac == nil {
			return nil
		}
