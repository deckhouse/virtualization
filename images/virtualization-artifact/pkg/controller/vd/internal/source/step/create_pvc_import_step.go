...
type PVCImportStepDiskService interface {
	StartPVCImport(ctx context.Context, pvcSize resource.Quantity, sc *storagev1.StorageClass, source *service.PVCImportSource, vd *v1alpha2.VirtualDisk, nodePlacement *provisioner.NodePlacement) error
}
...
func (s PVCImportStep) Take(ctx context.Context, vd *v1alpha2.VirtualDisk) (*reconcile.Result, error) {
	...
	err = s.disk.StartPVCImport(ctx, s.size, sc, s.source, vd, nodePlacement)
	switch {
	case err == nil:
		// OK.
