...
func (h MigrationHandler) Handle(ctx context.Context, vd *virtv2.VirtualDisk) (reconcile.Result, error) {
	...
	case none:
		return reconcile.Result{}, h.handleNone(ctx, vd)
	case migratePhase1:
		return reconcile.Result{}, h.handleMigratePhase1(ctx, vd)
	case migratePhase2:
		return reconcile.Result{}, h.handleMigratePhase2(ctx, vd)
	case revert:
...
func (a action) String() string {
	...
	case none:
		return "none"
	case migratePhase1:
		return "migratePhase1"
	case migratePhase2:
		return "migratePhase2"
	case revert:
		return "revert"
	case complete:
		return "complete"
...
func (h MigrationHandler) getActionIfMigrationInProgress(vd *virtv2.VirtualDisk, vm *virtv2.VirtualMachine, log *slog.Logger) (action, error) {
	...
	migratingVirtualDisk, _ := conditions.GetCondition(vdcondition.MigratingType, vd.Status.Conditions)
	if migratingVirtualDisk.Reason == vdcondition.MigratingWaitForTargetReadyReason.String() {
		return migratePhase2, nil
	}

	return none, nil
}

func (h MigrationHandler) getActionIfDisksShouldBeMigrating(ctx context.Context, vd *virtv2.VirtualDisk, log *slog.Logger) (action, error) {
...
func (h MigrationHandler) handleNone(_ context.Context, vd *virtv2.VirtualDisk) error {
...
func (h MigrationHandler) handleMigratePhase1(ctx context.Context, vd *virtv2.VirtualDisk) error {
	...
	return h.handleMigratePhase2(ctx, vd)
}

func (h MigrationHandler) handleMigratePhase2(ctx context.Context, vd *virtv2.VirtualDisk) error {
