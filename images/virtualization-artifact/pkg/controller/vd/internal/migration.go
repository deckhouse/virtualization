...
func (h MigrationHandler) getAction(ctx context.Context, vd *v1alpha2.VirtualDisk, log *slog.Logger) (action, error) {
	...
	if migratingPending {
		...
		if commonvd.StorageClassChanged(vd) {
			unfinalized, err := h.isKVVMIHasUnfinalizedVolumeMigration(ctx, vd, vm)
			if err != nil {
				return none, err
			}
			if unfinalized {
...
func (h MigrationHandler) getActionIfMigrationInProgress(ctx context.Context, vd *v1alpha2.VirtualDisk, vm *v1alpha2.VirtualMachine, log *slog.Logger) (action, error) {
	...
	switched, err := h.isGuestSwitchedToTargetPVC(ctx, vd, vm)
	if err != nil {
		return none, err
	}
	if switched {
...
// isGuestSwitchedToTargetPVC reports whether the current round's compute migration has
...
func (h MigrationHandler) isGuestSwitchedToTargetPVC(ctx context.Context, vd *v1alpha2.VirtualDisk, vm *v1alpha2.VirtualMachine) (bool, error) {
...
// isKVVMIHasUnfinalizedVolumeMigration reports whether the KVVMI still carries a
...
func (h MigrationHandler) isKVVMIHasUnfinalizedVolumeMigration(ctx context.Context, vd *v1alpha2.VirtualDisk, vm *v1alpha2.VirtualMachine) (bool, error) {
