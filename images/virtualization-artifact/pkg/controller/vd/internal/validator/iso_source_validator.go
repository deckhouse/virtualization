...
func (v *ISOSourceValidator) ValidateCreate(ctx context.Context, vd *v1alpha2.VirtualDisk) (admission.Warnings, error) {
	if vd.Spec.DataSource == nil {
		return nil, nil
	}

	if vd.Spec.DataSource.Type != v1alpha2.DataSourceTypeObjectRef || vd.Spec.DataSource.ObjectRef == nil {
		return nil, nil
	}
...
func (v *ISOSourceValidator) ValidateUpdate(ctx context.Context, _, newVD *v1alpha2.VirtualDisk) (admission.Warnings, error) {
	if newVD.Spec.DataSource == nil {
		return nil, nil
	}

	if newVD.Spec.DataSource.Type != v1alpha2.DataSourceTypeObjectRef || newVD.Spec.DataSource.ObjectRef == nil {
		return nil, nil
	}
