...
func (w *VirtualMachineWatcher) enqueueDisksAttachedToVM(_ context.Context, vm *virtv2.VirtualMachine) []reconcile.Request {
...
func (w *VirtualMachineWatcher) vmHasAttachedDisks(vm *virtv2.VirtualMachine) bool {
