...
func New(_ client.Client, nodeUSBDevice *reconciler.Resource[*v1alpha2.NodeUSBDevice, v1alpha2.NodeUSBDeviceStatus]) NodeUSBDeviceState {
	return &nodeUSBDeviceState{nodeUSBDevice: nodeUSBDevice}
}
