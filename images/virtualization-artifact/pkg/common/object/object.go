...
func PresentAnnotation(ctx context.Context, cl client.Client, obj client.Object, annoKey, annoValue string) error {
	op := patch.PatchAddOp
...
func AbsentAnnotation(ctx context.Context, cl client.Client, obj client.Object, annoKey string) error {
