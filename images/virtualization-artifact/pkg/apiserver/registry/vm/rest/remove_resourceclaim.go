...
func (r RemoveResourceClaimREST) Connect(ctx context.Context, name string, opts runtime.Object, responder rest.Responder) (http.Handler, error) {
	...
	location, transport, err := RemoveResourceClaimRESTLocation(ctx, r.vmLister, name, removeResourceClaimOpts, r.kubevirt, r.proxyCertManager, removeResourceClaimPather)
	if err != nil {
		return nil, err
	}
...
func RemoveResourceClaimRESTLocation(
	...
	name string,
	opts *subresources.VirtualMachineRemoveResourceClaim,
