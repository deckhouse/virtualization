...
func (r AddResourceClaimREST) Connect(ctx context.Context, name string, opts runtime.Object, responder rest.Responder) (http.Handler, error) {
	...
	location, transport, err := AddResourceClaimLocation(ctx, r.vmLister, name, addResourceClaimOpts, r.kubevirt, r.proxyCertManager, resourceClaimPather)
	if err != nil {
		return nil, err
	}
...
func AddResourceClaimLocation(
	...
	name string,
	opts *subresources.VirtualMachineAddResourceClaim,
