...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineUSBRedir) DeepCopyInto(out *VirtualMachineUSBRedir) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineUSBRedir.
func (in *VirtualMachineUSBRedir) DeepCopy() *VirtualMachineUSBRedir {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineUSBRedir)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VirtualMachineUSBRedir) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
