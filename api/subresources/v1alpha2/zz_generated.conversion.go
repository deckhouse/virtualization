...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*VirtualMachineMigrateCancel)(nil), (*subresources.VirtualMachineMigrateCancel)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_VirtualMachineMigrateCancel_To_subresources_VirtualMachineMigrateCancel(a.(*VirtualMachineMigrateCancel), b.(*subresources.VirtualMachineMigrateCancel), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*subresources.VirtualMachineMigrateCancel)(nil), (*VirtualMachineMigrateCancel)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_subresources_VirtualMachineMigrateCancel_To_v1alpha2_VirtualMachineMigrateCancel(a.(*subresources.VirtualMachineMigrateCancel), b.(*VirtualMachineMigrateCancel), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*url.Values)(nil), (*VirtualMachineMigrateCancel)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_url_Values_To_v1alpha2_VirtualMachineMigrateCancel(a.(*url.Values), b.(*VirtualMachineMigrateCancel), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_VirtualMachineMigrateCancel_To_subresources_VirtualMachineMigrateCancel(in *VirtualMachineMigrateCancel, out *subresources.VirtualMachineMigrateCancel, s conversion.Scope) error {
	return nil
}

// Convert_v1alpha2_VirtualMachineMigrateCancel_To_subresources_VirtualMachineMigrateCancel is an autogenerated conversion function.
func Convert_v1alpha2_VirtualMachineMigrateCancel_To_subresources_VirtualMachineMigrateCancel(in *VirtualMachineMigrateCancel, out *subresources.VirtualMachineMigrateCancel, s conversion.Scope) error {
	return autoConvert_v1alpha2_VirtualMachineMigrateCancel_To_subresources_VirtualMachineMigrateCancel(in, out, s)
}

func autoConvert_subresources_VirtualMachineMigrateCancel_To_v1alpha2_VirtualMachineMigrateCancel(in *subresources.VirtualMachineMigrateCancel, out *VirtualMachineMigrateCancel, s conversion.Scope) error {
	return nil
}

// Convert_subresources_VirtualMachineMigrateCancel_To_v1alpha2_VirtualMachineMigrateCancel is an autogenerated conversion function.
func Convert_subresources_VirtualMachineMigrateCancel_To_v1alpha2_VirtualMachineMigrateCancel(in *subresources.VirtualMachineMigrateCancel, out *VirtualMachineMigrateCancel, s conversion.Scope) error {
	return autoConvert_subresources_VirtualMachineMigrateCancel_To_v1alpha2_VirtualMachineMigrateCancel(in, out, s)
}

func autoConvert_url_Values_To_v1alpha2_VirtualMachineMigrateCancel(in *url.Values, out *VirtualMachineMigrateCancel, s conversion.Scope) error {
	// WARNING: Field TypeMeta does not have json tag, skipping.

	return nil
}

// Convert_url_Values_To_v1alpha2_VirtualMachineMigrateCancel is an autogenerated conversion function.
func Convert_url_Values_To_v1alpha2_VirtualMachineMigrateCancel(in *url.Values, out *VirtualMachineMigrateCancel, s conversion.Scope) error {
	return autoConvert_url_Values_To_v1alpha2_VirtualMachineMigrateCancel(in, out, s)
}
