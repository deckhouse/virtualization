...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*VirtualMachineVNCScreenshot)(nil), (*subresources.VirtualMachineVNCScreenshot)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_VirtualMachineVNCScreenshot_To_subresources_VirtualMachineVNCScreenshot(a.(*VirtualMachineVNCScreenshot), b.(*subresources.VirtualMachineVNCScreenshot), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*subresources.VirtualMachineVNCScreenshot)(nil), (*VirtualMachineVNCScreenshot)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_subresources_VirtualMachineVNCScreenshot_To_v1alpha2_VirtualMachineVNCScreenshot(a.(*subresources.VirtualMachineVNCScreenshot), b.(*VirtualMachineVNCScreenshot), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*url.Values)(nil), (*VirtualMachineVNCScreenshot)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_url_Values_To_v1alpha2_VirtualMachineVNCScreenshot(a.(*url.Values), b.(*VirtualMachineVNCScreenshot), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha2_VirtualMachineVNCScreenshot_To_subresources_VirtualMachineVNCScreenshot(in *VirtualMachineVNCScreenshot, out *subresources.VirtualMachineVNCScreenshot, s conversion.Scope) error {
	out.MoveCursor = in.MoveCursor
	return nil
}

// Convert_v1alpha2_VirtualMachineVNCScreenshot_To_subresources_VirtualMachineVNCScreenshot is an autogenerated conversion function.
func Convert_v1alpha2_VirtualMachineVNCScreenshot_To_subresources_VirtualMachineVNCScreenshot(in *VirtualMachineVNCScreenshot, out *subresources.VirtualMachineVNCScreenshot, s conversion.Scope) error {
	return autoConvert_v1alpha2_VirtualMachineVNCScreenshot_To_subresources_VirtualMachineVNCScreenshot(in, out, s)
}

func autoConvert_subresources_VirtualMachineVNCScreenshot_To_v1alpha2_VirtualMachineVNCScreenshot(in *subresources.VirtualMachineVNCScreenshot, out *VirtualMachineVNCScreenshot, s conversion.Scope) error {
	out.MoveCursor = in.MoveCursor
	return nil
}

// Convert_subresources_VirtualMachineVNCScreenshot_To_v1alpha2_VirtualMachineVNCScreenshot is an autogenerated conversion function.
func Convert_subresources_VirtualMachineVNCScreenshot_To_v1alpha2_VirtualMachineVNCScreenshot(in *subresources.VirtualMachineVNCScreenshot, out *VirtualMachineVNCScreenshot, s conversion.Scope) error {
	return autoConvert_subresources_VirtualMachineVNCScreenshot_To_v1alpha2_VirtualMachineVNCScreenshot(in, out, s)
}

func autoConvert_url_Values_To_v1alpha2_VirtualMachineVNCScreenshot(in *url.Values, out *VirtualMachineVNCScreenshot, s conversion.Scope) error {
	// WARNING: Field TypeMeta does not have json tag, skipping.

	if values, ok := map[string][]string(*in)["moveCursor"]; ok && len(values) > 0 {
		if err := runtime.Convert_Slice_string_To_bool(&values, &out.MoveCursor, s); err != nil {
			return err
		}
	} else {
		out.MoveCursor = false
	}
	return nil
}

// Convert_url_Values_To_v1alpha2_VirtualMachineVNCScreenshot is an autogenerated conversion function.
func Convert_url_Values_To_v1alpha2_VirtualMachineVNCScreenshot(in *url.Values, out *VirtualMachineVNCScreenshot, s conversion.Scope) error {
	return autoConvert_url_Values_To_v1alpha2_VirtualMachineVNCScreenshot(in, out, s)
}
