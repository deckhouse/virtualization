...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*APIVirtualMachine)(nil), (*subresources.APIVirtualMachine)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha2_APIVirtualMachine_To_subresources_APIVirtualMachine(a.(*APIVirtualMachine), b.(*subresources.APIVirtualMachine), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*subresources.APIVirtualMachine)(nil), (*APIVirtualMachine)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_subresources_APIVirtualMachine_To_v1alpha2_APIVirtualMachine(a.(*subresources.APIVirtualMachine), b.(*APIVirtualMachine), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha2_APIVirtualMachine_To_subresources_APIVirtualMachine(in *APIVirtualMachine, out *subresources.APIVirtualMachine, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	return nil
}

// Convert_v1alpha2_APIVirtualMachine_To_subresources_APIVirtualMachine is an autogenerated conversion function.
func Convert_v1alpha2_APIVirtualMachine_To_subresources_APIVirtualMachine(in *APIVirtualMachine, out *subresources.APIVirtualMachine, s conversion.Scope) error {
	return autoConvert_v1alpha2_APIVirtualMachine_To_subresources_APIVirtualMachine(in, out, s)
}

func autoConvert_subresources_APIVirtualMachine_To_v1alpha2_APIVirtualMachine(in *subresources.APIVirtualMachine, out *APIVirtualMachine, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	return nil
}

// Convert_subresources_APIVirtualMachine_To_v1alpha2_APIVirtualMachine is an autogenerated conversion function.
func Convert_subresources_APIVirtualMachine_To_v1alpha2_APIVirtualMachine(in *subresources.APIVirtualMachine, out *APIVirtualMachine, s conversion.Scope) error {
	return autoConvert_subresources_APIVirtualMachine_To_v1alpha2_APIVirtualMachine(in, out, s)
}
