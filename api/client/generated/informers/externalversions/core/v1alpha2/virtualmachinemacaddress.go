...
// VirtualMachineMACAddressInformer provides access to a shared informer and lister for
...
// NewVirtualMachineMACAddressInformer constructs a new informer for VirtualMachineMACAddress type.
...
func NewVirtualMachineMACAddressInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredVirtualMachineMACAddressInformer(client, namespace, resyncPeriod, indexers, nil)
}

// NewFilteredVirtualMachineMACAddressInformer constructs a new informer for VirtualMachineMACAddress type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
...
func (f *virtualMachineMACAddressInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredVirtualMachineMACAddressInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}
