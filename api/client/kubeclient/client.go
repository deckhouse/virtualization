...
type Client interface {
	...
	NodeUSBDevices(namespace string) virtualizationv1alpha2.NodeUSBDeviceInterface
...
func (c client) NodeUSBDevices(namespace string) virtualizationv1alpha2.NodeUSBDeviceInterface {
	return c.virtClient.VirtualizationV1alpha2().NodeUSBDevices(namespace)
}
