...
type VMSOPCreateVirtualMachineSpec struct {
	Mode VMSOPCreateVirtualMachineMode `json:"mode"`
...
// VMSOPCreateVirtualMachineMode defines the kind of the clone operation.
// * `Strict`: Strict clone as is in the snapshot.
// * `BestEffort`: BestEffort clone without deleted external missing dependencies.
// +kubebuilder:validation:Enum={DryRun,Strict,BestEffort}
type VMSOPCreateVirtualMachineMode string

const (
	VMSOPCreateVirtualMachineModeDryRun     VMSOPCreateVirtualMachineMode = "DryRun"
	VMSOPCreateVirtualMachineModeStrict     VMSOPCreateVirtualMachineMode = "Strict"
	VMSOPCreateVirtualMachineModeBestEffort VMSOPCreateVirtualMachineMode = "BestEffort"
)
