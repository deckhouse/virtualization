...
type VirtualDiskStatus struct {
	...
	// RealCapacity represents the actual physical size of the volume as provisioned by the CSI driver.
	...
	RealCapacity *resource.Quantity `json:"realCapacity,omitempty"`
