...
var SchemeGroupVersion = schema.GroupVersion{Group: "virtualization.deckhouse.io", Version: Version}
...
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(SchemeGroupVersion) //&ClusterVirtualMachineImage{},
