...
func convertSpecV3ToV2(v3Spec v1alpha3.VirtualMachineClassSpec) (VirtualMachineClassSpec, error) {
	...
	if v3Spec.CPU.Discovery != nil {
		v2Spec.CPU.Discovery = &CpuDiscovery{
			...
			if len(v3Policy.CoreFractions) > 0 {
				...
				for j, v3Fraction := range v3Policy.CoreFractions {
					...
					if fractionInt < 1 || fractionInt > 100 {
						return VirtualMachineClassSpec{}, fmt.Errorf("core fraction value must be between 1 and 100, got %d", fractionInt)
					}
...
func convertSpecV2ToV3(v2Spec VirtualMachineClassSpec) v1alpha3.VirtualMachineClassSpec {
	...
	if v2Spec.CPU.Discovery != nil {
		v3Spec.CPU.Discovery = &v1alpha3.CpuDiscovery{
