...
package nodepcidevicecondition

// Type represents the various condition types for the `NodePCIDevice`.
type Type string
...
const (
	// Assigned signifies that namespace is assigned for the device and corresponding PCIDevice resource is created in this namespace.
	...
	// InProgress signifies that device connection to namespace is in progress (PCIDevice resource creation).
