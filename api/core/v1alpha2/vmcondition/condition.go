...
const (
	...
	// TypeNeedEvict indicates that the VirtualMachine should be evicting from node.
	TypeNeedEvict Type = "NeedEvict"
)
...
const (
	...
	// ReasonNeedEvict indicates that the VirtualMachine should be evicting from node.
	ReasonNeedEvict Reason = "NeedEvict"
)
