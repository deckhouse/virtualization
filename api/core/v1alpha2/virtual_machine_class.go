...
// +crd-enricher:deckhouse:documentation:examples={apiVersion: virtualization.deckhouse.io/v1alpha2, kind: VirtualMachineClass, metadata: {name: example-class}, spec: {cpu: {type: Host}}}
